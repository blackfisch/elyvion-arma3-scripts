...
class ATNT_RscControlsGroup {
    ...
    class VScrollBar : ATNT_RscScrollBar
    {
        width = 0.021;
        autoScrollEnabled = 1;
    };

    class HScrollBar : ATNT_RscScrollBar
    {
        height = 0.028;
    };
...
class ATNT_RscControlsGroupNoScrollbars : ATNT_RscControlsGroup {
...
class ATNT_RscListNBox
{
    ...
    autoScrollDelay = 5;
    autoScrollRewind = 0;
    class ListScrollBar: ATNT_RscScrollBar{};
    class ScrollBar: ATNT_RscScrollBar{};
};
...
class ATNT_RscLine: ATNT_RscText {
    idc = -1;
    style = 176;
    x = 0.17;
    y = 0.48;
...
class ATNT_RscTitle: ATNT_RscText {
    style = 0;
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
    colorText[] = {0.95, 0.95, 0.95, 1};
};

class ATNT_RscPicture {
    shadow = 0;
    type = 0;
    style = 48;
    sizeEx = 0.023;
...
class ATNT_RscTextMulti: ATNT_RscText
{
    linespacing = 1;
    style = 0 + 16 + 0x200;
};

class ATNT_RscPictureKeepAspect : ATNT_RscPicture
{
    style = 0x30 + 0x800;
};

class ATNT_RscStructuredText {
    type = 13;
    style = 0;
    x = 0;
    y = 0;
...
class ATNT_RscButtonTextOnly : ATNT_RscButton {
    SizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
    colorBackground[] = {1, 1, 1, 0};
...
class ATNT_RscButtonMenu : ATNT_RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
...
class ATNT_RscShortcutButtonMain : ATNT_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    w = 0.313726;
...
class ATNT_RscSlider {
    h = 0.025;
    color[] = {1, 1, 1, 0.8};
    colorActive[] = {1, 1, 1, 1};
};

class ATNT_RscXSliderH
{
    style = 1024;
    type = 43;
    shadow = 2;
...
class ATNT_RscBackground: ATNT_RscText {
    type = 0;
    IDC = -1;
    style = 512;
    shadow = 0;
...
class ATNT_RscCombo {
    ...
    class ComboScrollBar : ATNT_RscScrollBar {};
};

class ATNT_RscToolbox {
    colorText[] = {0.95, 0.95, 0.95, 1};
    color[] = {0.95, 0.95, 0.95, 1};
